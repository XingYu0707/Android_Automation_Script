...
directory_exists("F:\\java\\Android\\adt-bundle-windows-x86_64-20140702\\sdk\\tools\\gehuajietu\\HOMETV");
...
jietu1.writeToFile('F:\\java\\Android\\adt-bundle-windows-x86_64-20140702\\sdk\\tools\\gehuajietu\\HOMETV\\HOMETV.png','png')
MonkeyRunner.sleep(1)
...
print "jietu1"
jietu1 = device.takeSnapshot()
jietu1.writeToFile('F:\\java\\Android\\adt-bundle-windows-x86_64-20140702\\sdk\\tools\\gehuajietu\\HOMETV\\HOMETV01.png','png')
MonkeyRunner.sleep(1)
device.press("KEYCODE_DPAD_LEFT",MonkeyDevice.DOWN_AND_UP)
MonkeyRunner.sleep(2)
print "HOMETV"
...
while(i<=10):
 ...
 jietu.writeToFile('F:\\java\\Android\\adt-bundle-windows-x86_64-20140702\\sdk\\tools\\gehuajietu\\HOMETV\\HOMETV'+j+'.png','png')
 print "HOMETV"+j
 i=i+1
