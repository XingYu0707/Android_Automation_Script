...
directory_exists("F:\\java\\Android\\adt-bundle-windows-x86_64-20140702\\sdk\\tools\\gehuajietu\\CableTest");
...
while(i<=6):
 ...
 jietu.writeToFile('F:\\java\\Android\\adt-bundle-windows-x86_64-20140702\\sdk\\tools\\gehuajietu\\CableTest\\CableTest'+j+'.png','png')
 device.press("KEYCODE_DPAD_RIGHT",MonkeyDevice.DOWN_AND_UP)
 print "jietu-CableTest"+j
 i=i+1
