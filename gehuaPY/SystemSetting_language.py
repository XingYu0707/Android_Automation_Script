...
directory_exists("F:\\java\\Android\\adt-bundle-windows-x86_64-20140702\\sdk\\tools\\gehuajietu\\language");
...
while(i<=3):
 ...
 jietu.writeToFile('F:\\java\\Android\\adt-bundle-windows-x86_64-20140702\\sdk\\tools\\gehuajietu\\language\\language'+j+'.png','png')
 device.press("KEYCODE_DPAD_DOWN",MonkeyDevice.DOWN_AND_UP)
 print "jietu-language"+j
 i=i+1
